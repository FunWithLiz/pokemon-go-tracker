...
(
    'Nidorina',
    'The female horn develops slowly. Prefers physical attacks such as clawing and biting.'
),
...
(
    'Nidoking',
    'It uses its powerful tail in battle to smash, constrict, then break the preys bones.'
),
...
(
    'Jigglypuff',
    'When its huge eyes light up, it sings a 
    mysteriously soothing melody that lulls its enemies to sleep.'
),
...
(
    'Gloom',
    'The fluid that oozes from its mouth is not drool. It is a nectar that is used to attract prey.'
),
...
(
    'Lickitung',
    'Its tongue can be extended like a chameleons. It leaves a tingling sensation when it licks enemies.'
),
